...
<h2 class="wp-block-heading has-secondary-color has-text-color has-link-color has-x-large-font-size">Families</h2>
<!-- /wp:heading --></div>
<!-- /wp:group -->

<!-- wp:paragraph -->
<p>A full programme of family activities including crafting, workshops, cookery classes, storytelling, dressing up and Halloween fun.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<h2 class="wp-block-heading has-blue-color has-text-color has-link-color has-x-large-font-size">Talks</h2>
<!-- /wp:heading --></div>
<!-- /wp:group -->

<!-- wp:paragraph -->
<p>Flagship talks from some of the country’s top historians, thinkers and broadcasters as well as more local, but no less interesting, voices.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<h2 class="wp-block-heading has-primary-color has-text-color has-link-color has-x-large-font-size">Walks &amp; Tours</h2>
<!-- /wp:heading --></div>
<!-- /wp:group -->

<!-- wp:paragraph -->
<p>A wide range of guided walks and tours, from Cirencester in the Civil War to Pubs Past &amp; Present.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<h2 class="wp-block-heading has-coral-color has-text-color has-link-color has-x-large-font-size">Revelry</h2>
<!-- /wp:heading --></div>
<!-- /wp:group -->

<!-- wp:paragraph -->
<p>Events ranging from forgotten local folk songs to a tasting history of curry and Cirencester’s lost brewery.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<h2 class="wp-block-heading has-marble-color has-text-color has-link-color has-x-large-font-size">Exhibitions</h2>
<!-- /wp:heading --></div>
<!-- /wp:group -->

<!-- wp:paragraph -->
<p>Special exhibitions and museum openings for festival week.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<h2 class="wp-block-heading has-green-color has-text-color has-link-color has-x-large-font-size">Charities</h2>
<!-- /wp:heading --></div>
<!-- /wp:group -->

<!-- wp:paragraph -->
<p>A range of off-programme activities with charity partners throughout festival week to reach a little deeper into the community.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->