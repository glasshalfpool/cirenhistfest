...
<div class="wp-block-group alignfull has-dawn-background-color has-background"><!-- wp:spacer {"height":"var:preset|spacing|medium"} -->
...
<h1 class="wp-block-heading has-blue-color has-text-color has-link-color has-mega-font-size">Main Header</h1>
<!-- /wp:heading --></div>
<!-- /wp:group -->
